...
| | |
|---|---|
| ▶ **Play in your browser** | [Crazy Diamond on itch.io](ITCH_URL) |
| 🎬 **Gameplay video** | [Watch the fight](GAMEPLAY_VIDEO_URL) |
| 🧭 **Code review video** | [Walkthrough of the architecture](CODE_REVIEW_VIDEO_URL) |
